...
with rasterio.open(file_path) as src:
    ...
    plt.savefig('bellandur_lake_2024_render.jpg', format='jpg', dpi=300, bbox_inches='tight')
    print("Saved 'bellandur_lake_2024_render.jpg' to your current folder!")
